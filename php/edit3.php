...
$exerc_id = $_GET["id"];
$excer = mysqli_query ($conexion,"SELECT * FROM exercise3 WHERE exerc_id = '$exerc_id'");
?>
...
<head>
	...
	<body>
	 ...
	 <form action="updt3.php" method="post">

			<?php $resultado = $excer;
			while($row=mysqli_fetch_assoc($resultado)) { ?>	

		<h2 class="ContainerTitle">Modificacion de Ejercicios <br> (Día 3)</h2>
