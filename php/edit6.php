...
$exerc_id = $_GET["id"];
$excer = mysqli_query ($conexion,"SELECT * FROM exercise6 WHERE exerc_id = '$exerc_id'");
?>
...
<head>
	...
	<body>
	 ...
	 <form action="updt6.php" method="post">

			<?php $resultado = $excer;
			while($row=mysqli_fetch_assoc($resultado)) { ?>	

		<h2 class="ContainerTitle">Modificacion de Ejercicios <br> (Día 6)</h2>
